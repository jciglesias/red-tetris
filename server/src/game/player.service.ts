...
import { PlayerState, createEmptyBoard, calculateSpectrum, BOARD_WIDTH, BOARD_HEIGHT } from 'src/types';
import type { Player, Board, Spectrum, Piece, PieceType } from 'src/types';
